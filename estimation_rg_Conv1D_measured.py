...
'''
x_train = load('measured dataset/average data/telelumen/original/x_train.npy')
x_test = load('measured dataset/average data/telelumen/original/x_test.npy')
x_val = load('measured dataset/average data/telelumen_whole/original/x_val.npy')

y_train = load('measured dataset/average data/telelumen/with pca/y_train.npy')
y_test = load('measured dataset/average data/telelumen/with pca/y_test.npy')
y_val = load('measured dataset/average data/telelumen/with pca/y_val.npy')
...
SPDs_array = load('measured dataset/average data/telelumen_whole/original/y_train.npy') 
...
# ground_truth_illumination = load('measured dataset/average data/telelumen/original/y_val.npy') # load original groundtruth
ground_truth_illumination = load('measured dataset/average data/telelumen_whole/original/y_val.npy') # load original groundtruth

#%%
"""
visualization of prediction
"""
wave = [i for i in range(380,740,10)] 

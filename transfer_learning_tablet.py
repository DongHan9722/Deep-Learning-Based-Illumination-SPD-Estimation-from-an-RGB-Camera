...
load the data
'''
x_train = load('measured dataset/average data/tablet/original/x_train.npy')
y_train = load('measured dataset/average data/tablet/pca/y_train.npy')
x_test = load('measured dataset/average data/tablet/original/x_test.npy')
y_test = load('measured dataset/average data/tablet/pca/y_test.npy')
x_val = load('measured dataset/average data/tablet/original/x_val.npy')
y_val = load('measured dataset/average data/tablet/pca/y_val.npy')
...
"""
SPDs_array = load('measured dataset/average data/tablet/original/y_train.npy')
...
ground_truth_illumination = load('measured dataset/average data/tablet/original/y_val.npy') # load original groundtruth
